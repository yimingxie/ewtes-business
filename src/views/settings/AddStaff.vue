      ...
      <div class="content">
        ...
        <el-form :model="addStaffForm" :rules="rules" ref="form"  label-width="105px" :hide-required-asterisk='true'>
          <el-row>
            <el-col :span="12">
              <el-form-item label="姓名：" prop="name">
                <el-input v-model="addStaffForm.name" placeholder="请输入姓名" size="small" maxlength="20"></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-form-item label="手机号：" prop="account">
            <el-input v-model="addStaffForm.account" placeholder="(将作为为app登录账号)请输入手机号" size="small" maxlength="11"></el-input>
          </el-form-item>
          <el-form-item label="身份证号：" prop="identity">
            <el-input v-model="addStaffForm.identity" placeholder="请输入身份证号" size="small" minlength="18"></el-input>
          </el-form-item>
          <el-form-item label="出生日期：" prop="birthday">
            <!-- <a-date-picker @change="aChangePickDate1" format="YYYY-MM-DD" :showToday="false" placeholder="请选择日期" style="width: 248px">
            </a-date-picker> -->
            <el-date-picker type="date" placeholder="请选择日期" v-model="addStaffForm.birthday" style="width: 248px" size="small"></el-date-picker>
          </el-form-item>
          <el-form-item label="从业日期：" prop="empTime">
            ...
            <el-date-picker type="date" placeholder="请选择日期" v-model="addStaffForm.empTime" style="width: 248px" size="small"></el-date-picker>
          </el-form-item>
          <el-form-item label="入职日期：">
            <!-- <a-date-picker @change="aChangePickDate3" format="YYYY-MM-DD" :showToday="false" placeholder="(选填)请选择日期" style="width: 248px">
            </a-date-picker> -->
            <el-date-picker type="date" placeholder="(选填)请选择日期" v-model="addStaffForm.entryTime" style="width: 248px" size="small"></el-date-picker>
          </el-form-item>
          <el-form-item label="部门：" prop="depId">
            ...
            <el-select @change="depSelectChange" v-model="addStaffForm.depId" placeholder="请选择部门" size="small">
              <el-option
          ...
          <el-form-item label="角色：" prop="roleId" >
            <el-select v-model="addStaffForm.roleId" placeholder="请选择角色" size="small">
              <el-option
...
export default {
    ...
    return {
      ...
      rules: {
        name: [
          ...
          // { max: 20, message: '请控制在20位字符以内', trigger: 'blur' },
        ],
        identity: [
  ...
  methods: {
        ...
        // for(var i = 0; i < val.length; i++){
          ...
          api.accountApi.getElevatorByArea(this.getElevatorByAreaParams1).then((res) => {
            if(res.data.code === 200 && res.data.message === 'success'){
                ...
                // console.log("dest::::" + this.getLIftDataFirst.length);
                //////////////////////////
    ...
    depSelectChange(val){
      ...
      this.checkList1 = selectRange.split(",") // 管辖区域code
    ...
    // 确认添加员工账号
    confirmAddAccount(){
      this.addStaffForm.majorRegCode = this.checkedLiftAs // 管辖电梯（第一负责人）
      this.addStaffForm.minorRegCode = this.checkedLiftBs // 管辖电梯（第二负责人）

      this.addStaffForm.areaCode = this.checkAreaList // 管辖区域code
      this.addStaffForm.manageArea = this.selectedAreaLabels.join(',') // 管辖区域
      ...
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          // 转时间戳
          this.addStaffForm.birthday = this.transformTimestamp(this.addStaffForm.birthday) 
          this.addStaffForm.empTime = this.transformTimestamp(this.addStaffForm.empTime)
          this.addStaffForm.entryTime = this.transformTimestamp(this.addStaffForm.entryTime)
