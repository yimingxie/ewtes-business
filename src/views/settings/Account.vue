  ...
  <el-dialog width="500px" title="添加账号" :visible.sync="add_dialogFormVisible">
    <el-form :model="addAccountForm" :label-width="formLabelWidth" :rules="addAccountRules" ref="addForm" label-position="top">
          ...
          <el-form-item label="名称" prop="account">
            <el-input v-model="addAccountForm.account" placeholder="请输入名称" auto-complete="off" clearable size="small"  maxlength="11"></el-input>
          </el-form-item>
          ...
          <el-form-item label="初始密码" prop="roleId" >
            <el-input v-model="addAccountForm.account" placeholder="请输入数字和字母组合6位以上的密码" auto-complete="off" clearable size="small"  maxlength="11"></el-input>
          </el-form-item>
