      ...
      <div class="panel">
        ...
        <div class="content">
          <div class="left">
            ...
            <!-- <img src="../../assets/imagesPark/hs/header.png"  alt="header" width="64" height="64"/> -->
    ...
    <el-dialog  width="662px" title="修改密码" :visible.sync="edit_dialogFormVisible" custom-class="addAccount">
      ...
      <el-form :model="EditAccountForm" :label-width="formLabelWidth" :rules="rules" ref="EditAccountForm">
        <el-form-item label="旧密码：" prop="old">
          <el-input type="password" v-model="EditAccountForm.old" placeholder="请输入旧密码" auto-complete="off" clearable size="small"></el-input>
        </el-form-item>
        <el-form-item label="新密码：" prop="salt">
          <el-input type="password" v-model="EditAccountForm.salt" placeholder="请输入新密码" auto-complete="off" clearable size="small"></el-input>
        </el-form-item>
        <el-form-item label="确认密码：" prop="again">
          <el-input type="password" v-model="EditAccountForm.again" placeholder="请再次输入新密码" auto-complete="off" clearable size="small"></el-input>
        </el-form-item>
      </el-form>
        ...
        if (valid) {
          api.accountApi.editPsd(_this.EditAccountForm).then((res) => {
            if(res.data.code == 200){
              ...
              _this.$message.error('旧密码错误，请重新输入');
            }
